...
sudo apt-get $OPT_APTGET install apache2 php5 php5-dev php-pear libapache2-mod-php5 php5-mysql php5-sqlite php5-intl php5-cli php5-gd mariadb-server-5.5
